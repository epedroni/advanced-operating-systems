...
/*
 Start a child process by arguments. Fills in spawninfo structure.
 Binary name is provided as argv[0]
*/
errval_t spawn_load_with_args(char* const argv[], int argc, struct spawninfo * si, struct lmp_chan* lc);
